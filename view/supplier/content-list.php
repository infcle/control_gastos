                     ...
                     <tr>
                        ...
                        <td>
                           <div class="flex align-items-center list-user-action">
                              <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar" href="<?php echo BASE_URL; ?>supplier/edit/<?php echo $sup['id_supplier']; ?>">
                              ...
                              <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Eliminar" href="#" onclick="if(confirm('¿Está seguro de eliminar este proveedor?')) { window.location.href='<?php echo BASE_URL; ?>supplier/delete/<?php echo $sup['id_supplier']; ?>'; }">
                                 <span class="btn-inner">
               ...
               <?php else: ?>
                  <tr>
                     <td colspan="3" class="text-center py-4">
                        ...
                        <a href="<?php echo BASE_URL; ?>supplier/create" class="btn btn-primary btn-sm mt-2">
